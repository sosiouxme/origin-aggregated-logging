...
#/usr/share/elasticsearch/bin/plugin -i io.fabric8.elasticsearch/openshift-elasticsearch-plugin/0.4
/usr/share/elasticsearch/bin/plugin -i openshift-elasticsearch-plugin -u http://file.rdu.redhat.com/~lmeyer/openshift-elasticsearch-plugin-0.4-SNAPSHOT.zip
